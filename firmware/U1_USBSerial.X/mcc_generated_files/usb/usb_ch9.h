...
#define USB_DESCRIPTOR_IAD              0x0B    // bDescriptorType for an Interface Association Descriptor. (IAD)
...
// *****************************************************************************
/* USB IAD Descriptor Structure

This struct defines the structure of a USB IAD Descriptor.  Note that this
structure may need to be packed, or even accessed as uint8_ts, to properly access
the correct fields when used on some device architectures.
*/
typedef struct PACKED _USB_IAD_DESCRIPTOR
{
    uint8_t bLength;               // Length of this descriptor.
